...
import akita.modules.sql.locks_sql as sql
from akita import dispatcher, SUDO_USERS, DEV_USERS, LOGGER
from akita.modules.disable import DisableAbleCommandHandler
from akita.modules.helper_funcs.chat_status import (can_delete, is_user_admin, user_not_admin, user_admin,
            ...
            if lockable == "bots":
                ...
                for new_mem in new_members:
                    if new_mem.is_bot:
                        ...
                        message.reply_text("Only admins are allowed to add bots to this chat! Behave or I'll ban you.")
            else:
                try:
                    message.delete()
