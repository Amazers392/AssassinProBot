...
from akita import dispatcher, BAN_STICKER
from akita.modules.disable import DisableAbleCommandHandler
from akita.modules.helper_funcs.chat_status import (is_user_admin, bot_admin, user_admin_no_reply, user_admin,
                                                     can_restrict)
from akita.modules.helper_funcs.extraction import extract_text, extract_user_and_text, extract_user
from akita.modules.helper_funcs.filters import CustomFilters
from akita.modules.helper_funcs.misc import split_message
from akita.modules.helper_funcs.string_handling import split_quotes
from akita.modules.log_channel import loggable
from akita.modules.sql import warns_sql as sql
from akita.modules.sql import rules_sql as sqlr
...
def warn(user: User, chat: Chat, reason: str, message: Message, warner: User = None) -> str:
    ...
    if is_user_admin(chat, user.id):
        # message.reply_text("Damn admins, They are too far from being warned!")
        return ""
