...
def totranslate(bot: Bot, update: Update):
    ...
    try:
        ...
        update.effective_message.reply_text(
            ...
            "Example: `/tr en ar` to translate from English to Arabic\n"
            "Or use: `/tr ar` for automatic detection and translating it into Arabic.\n"
            "See [List of Language Codes](https://telegra.ph/Supported-Languages-Codes-03-18) for a list of language codes.",
...
Example: /tr en (as reply to a message)
"""
