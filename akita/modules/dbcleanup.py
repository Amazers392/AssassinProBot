...
import akita.modules.sql.users_sql as user_sql
from akita import dispatcher, OWNER_ID, DEV_USERS
...
def dbcleanup(bot: Bot, update: Update):
    ...
    if invalid_chat_count or invalid_gban_count > 0:
        buttons = [
...
def leave_muted_chats(bot: Bot, update: Update):
    ...
    if muted_chats > 0:
        ...
        update.effective_message.reply_text(f"I am not muted in any chats.")
    progress_message.delete()
