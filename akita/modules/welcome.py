...
import akita.modules.sql.welcome_sql as sql
import akita.modules.sql.global_bans_sql as gban_sql
from akita import dispatcher, OWNER_ID, DEV_USERS, SUDO_USERS, SUPPORT_USERS, WHITELIST_USERS, LOGGER, MESSAGE_DUMP, SUPPORT_GROUP
from akita.modules.helper_funcs.chat_status import user_admin, is_user_ban_protected
from akita.modules.helper_funcs.misc import build_keyboard, revert_buttons
from akita.modules.helper_funcs.msg_types import get_welcome_type
from akita.modules.helper_funcs.string_handling import (markdown_parser,
                                                         escape_invalid_curly_brackets)
from akita.modules.log_channel import loggable
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text("Whoa‼️ One of my Developers just joined!")

            # Welcome Sudos
            elif new_mem.id in SUDO_USERS:
                update.effective_message.reply_text("Huh! A Sudo User just joined!💥\nStay Alert!")
