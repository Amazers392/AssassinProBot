...
from akita import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL, SUPPORT_CHANNEL, SUPPORT_GROUP, OWNER_USERNAME
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from akita.modules import ALL_MODULES
from akita.modules.helper_funcs.chat_status import is_user_admin
from akita.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("akita.modules." + module_name)
...
def donate(bot: Bot, update: Update):
    ...
    if chat.type == "private":
        ...
        try:
            ...
            update.effective_message.reply_text("I've messaged you about donating to my creator!")
        except Unauthorized:
