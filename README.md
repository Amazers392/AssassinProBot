...
Originally a marie fork - Agent 47 has evolved further and was built to be more useful for Anime Chats.
...
<details>
 ...
 Note: This instruction set is just a copy paste from marie, note that [DraX Robots](https://t.me/DraXRoBots) aims to handle support for @HitmanAgent47_Bot and now how to setup your own fork, if you find this bit confusing/tough to understand then we recommend you ask a dev, kindly avoid asking how to setup the bot instance in the support chat, it aims to help our own instance of the bot.
...
For queries or any issues regarding the bot please open an issue ticket or visit us at [DraX Robots](https://t.me/DraXRoBots)
