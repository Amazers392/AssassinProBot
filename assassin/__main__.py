...
from assassin import dispatcher, updater, TOKEN, WEBHOOK, SUDO_USERS, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL


#Needed to dynamically load modules
#NOTE: Module order is not guaranteed, specify that in the config file!
from assassin.modules import ALL_MODULES
from assassin.modules.helper_funcs.chat_status import is_user_admin
from assassin.modules.helper_funcs.misc import paginate_modules
from assassin.modules.translations.strings import tld, tld_help
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("assassin.modules." + module_name)
...
def start(bot: Bot, update: Update, args: List[str]):
    ...
    if update.effective_chat.type == "private":
        ...
        try:
            update.effective_message.reply_text("Need me?")
        except:
            print("Nut")
...
I'm built in python3, using the python-telegram-bot library.\n\n"
    ...
    text += "Join our [Support Group](https://t.me/AssassinRoBotSupport) (@AssassinRoBotSupport) if you need any support or help\n\n\
Join our [Updates Channel](https://t.me/AssassinUpdates) (@AssassinUpdates) if you want latest news on Assassin\n\n\
Want to add me to your group? [Click here!](t.me/Assassin_ProBot?startgroup=true)\n\n"
    
    
    keyboard = [[InlineKeyboardButton(text="🎉 Add me in your Group!", url="t.me/Assassin_ProBot?startgroup=true")]]
    keyboard += [[InlineKeyboardButton(text="❔ Help", callback_data="help_back")]]
    keyboard += [[InlineKeyboardButton(text="📢 Support Group", url="https://t.me/AssassinRoBotSupport"), InlineKeyboardButton(text="🔔 Updates", url="https://t.me/AssassinUpdates")]]
    keyboard += [[InlineKeyboardButton(text="🛠 Control panel", callback_data="cntrl_panel_M"), InlineKeyboardButton(text="🇺🇸 Language", callback_data="set_lang_")]]
...
def control_panel(bot, update):
    ...
    if query:
        ...
        M_match = "Assassin is the best bot" #LMAO, don't uncomment
