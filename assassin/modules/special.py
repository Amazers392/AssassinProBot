...
from assassin.modules.helper_funcs.chat_status import is_user_ban_protected, user_admin

import random
import telegram
import assassin.modules.sql.users_sql as sql
from assassin import dispatcher, OWNER_ID, SUDO_USERS, SUPPORT_USERS, LOGGER
...
MESSAGES = (
    ...
    "Heppi burfdey ",
    "Hep burf ",
    "Janamdin Mubarak Lawde ",
    "200rs Paytm kr ",
    "Bhai ka HAPPY BIRTHDAY ",
