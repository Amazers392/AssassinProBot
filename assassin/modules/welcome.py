...
import assassin.modules.sql.welcome_sql as sql
from assassin.modules.sql.antispam_sql import is_user_gbanned
from assassin import dispatcher, OWNER_ID, LOGGER, MESSAGE_DUMP
from assassin.modules.helper_funcs.chat_status import user_admin, is_user_ban_protected
from assassin.modules.helper_funcs.misc import build_keyboard, revert_buttons
from assassin.modules.helper_funcs.msg_types import get_welcome_type
    ...
    if should_welc:
        ...
        for new_mem in new_members:
            ...
            if new_mem.id == bot.id:
                ...
                bot.send_message(chat.id, "Thanks for adding me into your group❤! Hit /help to more about me ❤!")
