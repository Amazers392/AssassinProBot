...
from assassin.modules.disable import DisableAbleCommandHandler, DisableAbleRegexHandler
from assassin.modules.sql import afk_sql as sql
from assassin.modules.users import get_user_id
...
def afk(bot: Bot, update: Update):
    ...
    update.effective_message.reply_text(tld(chat.id, f"{fname} have taken rest from Virtual World"))
...
def no_longer_afk(bot: Bot, update: Update):
    ...
    if res:
        ...
        try:
            update.effective_message.reply_text(tld(chat.id, f"{firstname} is back Online"))
        except:
            return
