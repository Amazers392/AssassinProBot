...
from assassin.modules.helper_funcs.chat_status import bot_admin, can_promote, user_admin, can_pin, dev_user
...
def do(func, bot, update):
    ...
    os.chdir(os.getcwd())
    with open('%s/assassin/modules/helper_funcs/temp.txt' % os.getcwd(), 'w') as temp:
        temp.write(body)
