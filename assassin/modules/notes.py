...
from assassin import dispatcher, MESSAGE_DUMP, LOGGER
		...
		if note.is_reply:
			...
			try:
				...
				if excp.message == "Entity_mention_user_invalid":
					...
					message.reply_text("This note could not be sent, as it is incorrectly formatted, Please ask in @assassinAyaGroup if you can't figure out why!")
...
def cmd_get(bot: Bot, update: Update, args: List[str]):
	if len(args) >= 2 and args[1].lower() == "noformat":
		...
		update.effective_message.reply_text("Be more Specific plox.")
