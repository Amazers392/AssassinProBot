...
from assassin import dispatcher, AI_API_KEY, OWNER_ID, SUPPORT_GROUP, MESSAGE_DUMP
import assassin.modules.sql.chatbot_sql as sql
...
def check_message(bot: Bot, message):
    ...
    if message.text.lower() == "assassin":
        return True
    if reply_msg:
...
It's a really Cool!
Commands: These only work for Staff users, if you want this feature enabled, reach out to our Support Group!
