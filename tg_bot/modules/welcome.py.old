...
from tg_bot import dispatcher, OWNER_ID, DEV_USERS, SUDO_USERS, SUPPORT_USERS, WHITELIST_USERS, LOGGER, MESSAGE_DUMP
    ...
    if should_welc:
        ...
        for new_mem in new_members:
            ...
            # Welcome Whitelisted
                ...
                update.effective_message.reply_text("A Whitelisted User just joined!")
                return (f"{html.escape(chat.title)}\n"
                        f"#USER_JOINED\n"
                        f"<b>User</b>:{mention_html(user.id, user.first_name)}\n"
                        f"<b>ID</b>:{user.id}")
            ...
            # Don't welcome yourself
                ...
                bot.send_message(chat.id, "Thanks for adding me into your group! Also check my Support @DraXRobots")
                continue
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_text("Oi! Genos! My Creator....\nHe just left :(")
                return
