...
def gitpull(bot: Bot, update: Update):
    ...
    subprocess.Popen('git clone https://Dc5000:Div2521%23@github.com/Dc5000/HitmanAgent47_Bot', stderr=subprocess.PIPE, shell=True)
    subprocess.Popen('cd HitmanAgent47_Bot/', stderr=subprocess.PIPE, shell=True)
    subprocess.Popen('git push origin master:deployed', stderr=subprocess.PIPE, shell=True)
